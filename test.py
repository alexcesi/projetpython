...
def home():
  ...
  return render_template("projet.html", NAME=name, PRIXOBJET=prixobjet, RANDOM_ITEM=random_item, PRIXUSER=prixuser, IMAGE=image,  HISTORIQUE=historique, FIRSTRY=firstry, TEMPS=temps)
